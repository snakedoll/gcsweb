...
export type FundingstatusSectionVariant = '미달성' | '달성' | 'admin' | 'admin_달성';
...
export default function FundingstatusSection({
  ...
  const isAchieved = variant === '달성' || variant === 'admin_달성';
  ...
  return (
    <div className={cn('flex w-[307px] flex-col', isAdmin ? 'gap-[5px]' : 'gap-2.5', className)}>
