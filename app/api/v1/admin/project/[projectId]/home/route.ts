...
export async function PATCH(
  ...
  try {
    ...
    const updated = await repo.project.update({
      where: { id: pathProjectId },
      data: { isHome: safeIsHome },
      select: { id: true, isHome: true, updatedAt: true },
    });
    ...
    console.error('Admin project home toggle error:', error);
