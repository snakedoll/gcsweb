...
/**
 * QRshop 전용: item.json 기준 금액으로 Buy Now(현장수령) 주문을 만들고 PortOne 결제 전 단계까지 동일 스키마를 사용한다.
 * 실제 DB Product는 QRSHOP_BUYNOW_PRODUCT_ID 한 건(가격 0)이며, 행 단가는 optionData.additionalPrice 로 반영한다.
 */
